...
@section('content')
    ...
    <div class="mb-6 flex justify-between items-center">
        <div>
            <h1 class="text-2xl font-bold text-slate-800">Edit Paket</h1>
            <p class="text-slate-500 text-sm">Update harga atau nama layanan</p>
        </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input type="number" name="harga_per_kg" value="{{ $paket->harga_per_kg }}" required 
                ...
                <div>
                    ...
                    <input type="text" name="estimasi_waktu" value="{{ $paket->estimasi_waktu }}" required 
                        class="w-full px-4 py-2 border border-slate-300 rounded-lg focus:ring-2 focus:ring-blue-100 focus:border-blue-500 outline-none transition">
                </div>
            </div>
